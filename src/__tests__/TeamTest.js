...
describe("Team view" ,() => {
    ...
    test('Should display team page', async () => {
        ...
        const Members = [
            {'name' : 'member1', 'id' : '1', 'grade' : 8, start:{seconds:4000000}, 'coding' : 2, 'building' : 2, 'description' : 'member1'},
            {'name' : 'member2', 'id' : '2', 'grade' : 7, start:{seconds:6000000}, 'coding' : 1, 'building' : 1, 'description' : 'member2'},
            {'name' : 'member3', 'id' : '3', 'grade' : -1, start:{seconds:3000000}, end : {seconds:2000000}, 'coding' : 1, 'building' : 2, 'description' : 'member3'}

        ]

        const view = render(
            <div>
                <MockDataProvider team={Members}>
                    <Team/>
                </MockDataProvider>
            </div>
        );
