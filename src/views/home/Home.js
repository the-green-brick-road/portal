    ...
    return (
        <Fragment>
            ...
            <Container style={{ fontSize:'14px', paddingTop:'20px', paddingBottom:'20px' }}>
                ...
                <Typography variant="body2" style={{ fontSize:'14px' }}> Are you excited by the cutting-edge world of robotics? Do you want to be part of a community where innovation, creativity, and technical know-how come together to create fantastic, forward-thinking machines? Look no further! You've arrived at the right place. </Typography>
                <Typography variant="body2" style={{ fontSize:'14px', paddingTop:10 }}> Our robotics team is not just a group - it's an immersive experience, a hub of exceptional minds working together to reshape the future. We are a diverse, dedicated team of students who share a common passion: using technology to solve complex problems and push the boundaries of what's possible. </Typography>
                <Typography variant="body2" style={{ fontSize:'14px', paddingTop:10 }}> We all share a love for robotics, engineering, and innovation. We design, build, program, and operate lego robots, aiming to compete in local, national, and international competitions. But more than that, we are a community. We are learners, teachers, and explorers on a never-ending quest for knowledge and improvement. </Typography>
                ...
                <Typography variant="body2" style={{ fontSize:'14px', paddingTop:10 }}> Joining us isn't just about participating in competitions or building robots; it's about developing critical thinking skills, learning to work in a team, and cultivating a passion for science and technology that will last a lifetime. </Typography>
